                        ...
                        <div className="bg-white rounded-lg  mt-11 p-4 w-[35%] drop-shadow-sm transform transition-all">
                            ...
                            <div className="flex mt-3">
                                <div className="w-full">
                                    <label htmlFor="first_name" className="block mb-1  font-medium text-gray-900 dark:text-white">Task</label>
                                    <textarea type="text" id="first_name" className="bg-gray-50 b   order border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="What's your task..." required />
                                </div>
                            </div>
